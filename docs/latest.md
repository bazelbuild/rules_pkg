...
<div class="since"><i>Since 0.7.2): File name substitution now supports the $(var</i></div> syntax.
<div class="since"><i>Since 0.7.2): File name substitution now supports direct use of [ctx.var](https://bazel.build/rules/lib/ctx#var</i></div>.
